...
> to use the `amberbase-client` library to do that you need to add `.withAdminRole()` to the creation of the amber client. Otherwise the session will not include admin role.
